...
@patch(_LIVE_PATCHES["run_resolution"], create=True)
@patch(_LIVE_PATCHES["get_snapshot"], return_value={"open_positions": 2, "total_value": 50.0}, create=True)
@patch(_LIVE_PATCHES["record_fill"], create=True)
@patch(_LIVE_PATCHES["place_order"], create=True)
@patch(_LIVE_PATCHES["compute_size"], return_value=10.0, create=True)
@patch(_LIVE_PATCHES["get_balance"], return_value=100.0, create=True)
@patch(_LIVE_PATCHES["init_clob"], create=True)
...
@patch(_LIVE_PATCHES["record_fill"], create=True)
@patch(_LIVE_PATCHES["place_order"], create=True)
@patch(_LIVE_PATCHES["compute_size"], return_value=2.0, create=True)  # Below MIN_TRADE_SIZE (5.0)
@patch(_LIVE_PATCHES["get_balance"], return_value=100.0, create=True)
@patch(_LIVE_PATCHES["init_clob"], create=True)
@patch(_LIVE_PATCHES["sqlite_connect"])
@patch(_PATCHES["sleep"])
...
@patch(_LIVE_PATCHES["exec_available"], True)
@patch(_LIVE_PATCHES["run_resolution"], create=True)
@patch(_LIVE_PATCHES["get_snapshot"], return_value={"open_positions": 1, "total_value": 50.0}, create=True)
@patch(_LIVE_PATCHES["record_fill"], create=True)
@patch(_LIVE_PATCHES["place_order"], create=True)
@patch(_LIVE_PATCHES["compute_size"], return_value=10.0, create=True)
@patch(_LIVE_PATCHES["get_balance"], return_value=100.0, create=True)
...
@patch(_LIVE_PATCHES["exec_available"], True)
@patch(_LIVE_PATCHES["run_resolution"], create=True)
@patch(_LIVE_PATCHES["get_snapshot"], return_value={"open_positions": 0, "total_value": 100.0}, create=True)
@patch(_LIVE_PATCHES["record_fill"], create=True)
@patch(_LIVE_PATCHES["place_order"], create=True)
@patch(_LIVE_PATCHES["compute_size"], return_value=10.0, create=True)
@patch(_LIVE_PATCHES["get_balance"], return_value=100.0, create=True)
...
@patch(_LIVE_PATCHES["run_resolution"], create=True)
@patch(_LIVE_PATCHES["get_snapshot"], return_value={"open_positions": 0, "total_value": 100.0}, create=True)
@patch(_LIVE_PATCHES["init_clob"], side_effect=Exception("CLOB connection failed"), create=True)
@patch(_LIVE_PATCHES["sqlite_connect"])
@patch(_PATCHES["sleep"])
@patch(_PATCHES["tg_scan_fmt"], return_value="scan")
@patch(_PATCHES["tg_send"])
...
@patch(_LIVE_PATCHES["place_order"], create=True)
@patch(_LIVE_PATCHES["compute_size"], return_value=10.0, create=True)
@patch(_LIVE_PATCHES["get_balance"], return_value=250.0, create=True)
@patch(_LIVE_PATCHES["init_clob"], create=True)
@patch(_LIVE_PATCHES["sqlite_connect"])
@patch(_PATCHES["sleep"])
@patch(_PATCHES["tg_scan_fmt"], return_value="scan")
...
@patch(_LIVE_PATCHES["exec_available"], True)
@patch(_LIVE_PATCHES["cancel_stale"], return_value=3, create=True)
@patch(_LIVE_PATCHES["run_resolution"], create=True)
@patch(_LIVE_PATCHES["get_snapshot"], return_value={"open_positions": 0, "total_value": 100.0}, create=True)
@patch(_LIVE_PATCHES["record_fill"], create=True)
@patch(_LIVE_PATCHES["place_order"], create=True)
...
@patch(_LIVE_PATCHES["cancel_stale"], create=True)
@patch(_LIVE_PATCHES["run_resolution"], create=True)
@patch(_PATCHES["sleep"])
@patch(_PATCHES["tg_scan_fmt"], return_value="scan")
@patch(_PATCHES["tg_trade_fmt"], return_value="alert")
